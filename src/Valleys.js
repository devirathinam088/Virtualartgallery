...
import { ArtvalleyList } from "./data/Datavalleys";
...
const Paintings = () => {
    return (
      <div style={{backgroundColor:'#B2FFFF'}}>
    <Layout  >
      <Box sx={{ display: "flex", flexWrap: "wrap", justifyContent: "center" }}>
        {ArtvalleyList.map((arts) => (
          <Card sx={{ maxWidth: "490px", display: "flex", m: 2 , marginLeft:"1px"}}>
            <CardActionArea>
              ...
              <CardContent>
               ...
               <h2> Title:"Valley"</h2><br/>
            <h3>  Artist: Tejal Patel</h3><br/>
            <h3>Medium: Acryclic On Canvas</h3> <br/>
